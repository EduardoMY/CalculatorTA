...
class HXCPP_CLASS_ATTRIBUTES  Main_obj : public ::openfl::display::Sprite_obj{
	...
	public:
		...
		::openfl::text::TextField operation;
		::openfl::text::TextField operations;
		::openfl::text::TextField resultDecimal;
		::openfl::text::TextField resultBinary;
		::openfl::text::TextField resultHexadecimal;
		::Calculator calc;
		virtual Void init( );
		Dynamic init_dyn();
